...
const renderWithLayouts = require('./middlewares/renderWithLayouts')
...
app.use(renderWithLayouts('_layout'));
app.use(cookieParser(process.env.COOKIE_SECRET));

// -- DATA / DB / CONFIG --
// -- USE MONGODB --
// 1. Create connection string
const connectionString = process.env.MONGODB_URI || 'mongodb+srv://goffer21:ktKlKc1QqTuCqMr2@cluster0.ube9xwi.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0';
